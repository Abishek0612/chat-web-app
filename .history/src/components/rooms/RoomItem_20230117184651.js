    ...
    return (
        <div style={{ height: '100%' }}>
            <div className="d-flex justify-content-between align-items-center h-100 ">
                ...
                <TimeAgo
                    datetime={lastMessages ? new Date(lastMessages.createdAt) : new Date(createdAt)} className='font-normal text-black-45 '
                />
            </div>
                    ...
                    lastMessages ? (
                        <>
                            ...
                            <div className='text-disappear ml-2'>
                                <div className='italic' >{lastMessages.author.name}</div>
